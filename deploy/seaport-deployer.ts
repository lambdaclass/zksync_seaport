...
import { deployContract, getProvider, getWallet, deploySafeCreate2Contract} from "./utils";
...
export default async function () {
  ...
  const transferHelper_address = await deploySafeCreate2Contract(provider, transferHelper, salt, immutableCreate2);
  ...
  const seaportValidatorHelper_address = await deploySafeCreate2Contract(provider, seaportValidatorHelper, salt, immutableCreate2);
  ...
  const readOnlyOrderValidatorHelper_address = await deploySafeCreate2Contract(provider, readOnlyOrderValidatorHelper, salt, immutableCreate2);
  ...
  const seaportValidator_address = await deploySafeCreate2Contract(provider, seaportValidator, salt, immutableCreate2);
  ...
  const requestValidator_address = await deploySafeCreate2Contract(provider, requestValidator, salt, immutableCreate2);
  ...
  const criteriaHelper_address = await deploySafeCreate2Contract(provider, criteriaHelper, salt, immutableCreate2);
  ...
  const validatorHelper_address = await deploySafeCreate2Contract(provider, validatorHelper, salt, immutableCreate2);
  ...
  const orderDetailsHelper_address = await deploySafeCreate2Contract(provider, orderDetailsHelper, salt, immutableCreate2);
  ...
  const fulfillmentsHelperr_address = await deploySafeCreate2Contract(provider, fulfillmentsHelper, salt, immutableCreate2);
  ...
  const suggestedActionHelper_address = await deploySafeCreate2Contract(provider, suggestedActionHelper, salt, immutableCreate2);
  ...
  const executionsHelper_address = await deploySafeCreate2Contract(provider, executionsHelper, salt, immutableCreate2);
  ...
  const seaportNavigator_address = await deploySafeCreate2Contract(provider, seaportNavigator, salt, immutableCreate2); 
